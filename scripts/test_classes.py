...
import pandas as pd
from src.data_ingestion import DataProfiler, SchemaMapper, FileFingerprinter
...
print(f"✅ Default columns added: {['department' in mapped_df.columns, 'criticality' in mapped_df.columns]}")
